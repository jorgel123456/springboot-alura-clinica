...
class IMedicoRepositoryTest {
    ...
    //inpotaciones de variables y clases o objetos
    @Autowired
    ...
    private DatosRegistrarMedico datosMedico(String nombre, String email, String documento, Especialidad especialidad) {
        return new DatosRegistrarMedico(
                nombre,
                email,
                "61999999999",
                documento,
